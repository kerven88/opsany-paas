...
class GetServerModelData(Component):
    """
    apiMethod GET
    ...
    class Form(BaseComponentForm):
        ...
        def clean(self):
            return self.get_cleaned_data_when_exist(keys=["model_code", "search_type", "search_data", "page", "per_page", "run_status"])
    ...
    def handle(self):
       ...
       # 请求系统接口
        response = self.outgoing.http_client.get(
            host=configs.host,
            path='{}get-server-model-data/'.format(base_api_url),
            params=params,
