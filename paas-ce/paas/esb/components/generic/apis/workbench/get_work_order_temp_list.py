...
class GetWorkOrderTempList(Component):
    """
    apiMethod GET
    ...
    class Form(BaseComponentForm):
        ...
        def clean(self):
            return self.get_cleaned_data_when_exist(keys=["id", "current", "pageSize", "folder_id", "data_type", "name_or_describe", "username", "form_fields"])
    ...
    def handle(self):
        ...
        response = self.outgoing.http_client.get(
            host=configs.host,
            path='{}work-order-temp-list/'.format(base_api_url),
            params=params,
            data=None,
